...
const char *ssid =  "Lidia";   // cannot be longer than 32 characters!
const char *pass =  "coracora";   //
 
const char *mqtt_server = "m11.cloudmqtt.com";
const int mqtt_port = 11698;
const char *mqtt_user = "jqudulxl";
const char *mqtt_pass = "FdN9X5z2f00b";
